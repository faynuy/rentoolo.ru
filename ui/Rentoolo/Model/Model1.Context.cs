...
namespace Rentoolo.Model
{
    ...
    public partial class RentooloEntities : DbContext
    {
        ...
        public virtual DbSet<NewsFaynuy> NewsFaynuy { get; set; }
        ...
        public virtual ObjectResult<spGetCommentsTest_Result> spGetCommentsTest(Nullable<long> objectId, Nullable<System.Guid> userId)
        {
            var objectIdParameter = objectId.HasValue ?
                new ObjectParameter("objectId", objectId) :
                new ObjectParameter("objectId", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetCommentsTest_Result>("spGetCommentsTest", objectIdParameter, userIdParameter);
        }
